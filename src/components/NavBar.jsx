  ...
  return (
   <>
      <nav className=" items-center justify-between gap-4 fixed-top hidden md:flex bg-orange-300">
            <Link to="/">
              <img src="https://yt3.googleusercontent.com/lIPqzDapkueNly7PPgNHsaxRbpaIubc1YXFjVjIwp9MTa2jUsgD_j8beueFFtzGb4Ds_QHvCqg=s900-c-k-c0x00ffffff-no-rj" alt="Foto Logo" width={60}/>
            </Link>
      ...
      <nav className="md:hidden navbar navbar-orange bg-orange-300 fixed-top">
        <div className="container-fluid flex justify-between">
          <Link to="/"> <img src="https://yt3.googleusercontent.com/lIPqzDapkueNly7PPgNHsaxRbpaIubc1YXFjVjIwp9MTa2jUsgD_j8beueFFtzGb4Ds_QHvCqg=s900-c-k-c0x00ffffff-no-rj" alt="Foto Logo" width={60}/></Link>
